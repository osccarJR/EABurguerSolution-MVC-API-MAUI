...
namespace EABurguerSolution.Controllers
{
    public class PromoController : Controller
    {
        ...
        public PromoController(EABurguerSolutionContext context)
        {
            _context = context;
        }
        ...
        {
            var eABurguerSolutionContext = _context.Promo.Include(p => p.Burguer);
            return View(await eABurguerSolutionContext.ToListAsync());
        }
        ...
        {
            ViewData["BurguerID"] = new SelectList(_context.Set<Burguer>(), "BurguerId", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("PromoID,Descripcion,FechaPromo,BurguerID")] Promo promo)
        {
            ...
            ViewData["BurguerID"] = new SelectList(_context.Set<Burguer>(), "BurguerId", "Name", promo.BurguerID);
            return View(promo);
        }
